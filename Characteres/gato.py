...
def draw_legs(p):
    ...
    glRotate(p.leg_swing if p.walking else 0, 1, 0, 0)
    glTranslate(-0.25, -0.25, -0.5)
    ...
    if p.front_paws_up_active:
        ...
        glRotate(-p.arm_left_angle, 1, 0, 0)
    glTranslate(-2.75, -0.25, -0.5)
    ...
    if p.front_paws_up_active:
        ...
        glRotate(p.arm_right_angle, 1, 0, 0)
    glTranslate(-2.75, -0.75, -0.5)
